...
// Based upon a .frag from Sabine62 from Sat Aug 25 15:49:49 2018
...
float sq_r, r, dr, r1, theta, phi, r_pow, theta_pow, phi_pow, pow_eff, fac_eff, cth, cph, sph, sth, tmpx, tmpy, tmpz, tmpx2, tmpy2, tmpz2, r_zxy, r_cxy, h;
vec3 c;
int i;
...
// Preparation operations
    vec3 z = pos;
    float pow_eff = 1.0 - Power;
    float fac_eff = (Power - 1.0)/Power;
    r1 = length(z);
    dr = 1.0;
    i = 0;
    c = (Julia ? JuliaC : pos);
...
maxIterAO = 83
FudgeAO = 0.563467492
AO_ambient = 0.8369352
AO_camlight = 0.409090908
AO_pointlight = 0.785478547
AoCorrect = 0.1568816
Specular = 0.116207952
SpecularExp = 16
CamLight = 1,0.90196079,0.831372559,0.816793893
AmbiantLight = 0.78039217,0.858823538,1,0.770491803
Reflection = 0.337254912,0.41568628,0.450980395
ReflectionsNumber = 2
SpotGlow = true
SpotLight = 1,0.886274517,0.745097995,2.285714
LightPos = -0.9674234,-0.8094768,-4.481737
LightSize = 0
LightFallOff = 0.0456349
LightGlowRad = 0
LightGlowExp = 4.004951
HardShadow = 0.999002
ShadowSoft = 0
ShadowBlur = 0.0088409
perf = true
SSS = true
sss1 = 0.1975309
sss2 = 0.4615385
